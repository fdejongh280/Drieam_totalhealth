  ...
  $('#locator #zoeken').on('click',function(e) {
    e.preventDefault();
...
console.log(address);
  ...
  function resultstotal(resultstotal, radius, search, circlearea) {
    $('#results').empty().append('<p class="col">' + resultstotal + ' therapeut(en) binnen ' + radius + 'km rond ' + search + '</p><ol class="col"></ol>');
    ...
    for (i = 0; i < in_area.length; i++) {
      ...
      $('#results ol').append('<li class = "therapist">' +
